...
/**
 * Poruka potvrde. Sastoji se od korinsikovog User ID-a, koda i rednog broja paketa.
 * @author Filip
 *
 */
public class ACK extends Message {
	...
	/**
	 * Metoda koja stvara polje bajtova iz svih podataka poruke ACK.
	 * 
	 */
	@Override
